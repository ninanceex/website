<section class="section section-faq js-tabs" id="faq">
    ...
    <div class="tabs">
        <a href="#faq-1" class="current">{{__('Ninance platform')}}</a>
        <a href="#faq-2">{{__('NIC tokens')}}</a>
    ...
    <div class="wrapper">
        <div class="accordion js-tab" id="faq-1">
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-content">
                    {!!__('"Tokenized funds" will be a key element of the system. <a href="https://thetoken.io" target="_blank">The Token Fund</a> that is currently working is an example or prototype, it was created and developed by the Ninance team.')!!}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-4">
                    {{__('Is Ninance itself a trading exchange or is it a gateway to access trading exchanges?')}}
                </label>

                <div class="accordion-item-content">
                    {!!__('Ninance is not an exchange. Individual investors will not be using the platform as an exchange, meanwhile, investors will be able to buy tokens of Funds and Traders (to make a choice, buy, keep tokens on the platform, repay tokens, receive revenue, etc.) <br> For Funds and Traders Ninance will be a gateway for entering to exchanges via API, using trading terminal.') !!}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-content">
                    {!! __('Yes, the alfa-version will be functional for early-bird Funds and Traders which will announce their partnership with Ninance. The first partners of Ninance (funds and traders) have the opportunity to receive significant funds for managment at the start of work with Ninance.') !!}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-5">
                    {{__('How will Ninance find funds and traders to use its alpha product?')}}
                </label>
            ...
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-11">
                    {{__('What is unique key features of Ninance, that differs it from similar services?')}}
                </label>
        ...
        <div class="accordion js-tab" id="faq-2">
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-2-1">
                    {{__('What is NIC token?')}}
                </label>

                <div class="accordion-item-content">
                    {{__('NIC is an utility token that providing an access to the platform’s services. A fund manager or trader who wishes to operate his own fund on the platform, acquires NIC tokens and deposits them on the platform. These funds in the NIC format, are placed in the portfolio of the Fund or Trader and are valued in the portfolio like any other assets. The share of NIC-tokens in portfolios should be maintained at a level of at least 5%.')}}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-2-2">
                    {{__('What is the price of one NIC token?')}}
                </label>

                <div class="accordion-item-content">
                    {{__('The established price (1 NIC = 0.005 USD) is a price of initial token offering.')}}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-13">
                    {{__('What amount of NIC tokens can be issued?')}}
                </label>

                <div class="accordion-item-content">
                    {{__('The number of NICs will be fixed at the end of NIC. Max. 31 000 000 NIC. No additional creation is available.')}}
                </div>
            </div>
        </div>
        ...
        <div class="accordion js-tab" id="faq-3">
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-3-1">
                    {{__('What is a NIC crowdsale?')}}
                </label>

                <div class="accordion-item-content">
                    {{__('NIC - Token Generation Event. It is a synonym of the ICO. We use the NIC term because NIC tokens but not coins will be issued.')}}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-content">
                    {!!__('You can use only ETH address. You will receive NIC tokens after token distribution period on this address. Do not use exchanges or online services addresses, you will not be able to receive NIC there. If you do not own an ETH address, we recommend you to create one on &nbsp;<a href="https://myetherwallet.com" target="_blank">MyEtherWallet</a>.') !!}
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <label class="heading-2" for="item-3-6">
                    {{__('In which countries will the NIC be compliant and able to accept funds from resident investors? Or, in which countries will the NIC not be accessible?')}}
                </label>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-content">
                    {!!__('Currently, there is still an opportunity to participate in a private sale. If you are a fund or a major investor, you can&nbsp;<a href="mailto:hello@Ninance.io">contact us</a>&nbsp;for a special offer. During the NIC crowdsale period bonuses are not provided.') !!}
                </div>
            </div>
        </div>
    </div>
