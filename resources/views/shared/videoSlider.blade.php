    ...
    <div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <p class="video-title">{{__('Watch this simple three-minute video explainer for Ninance')}}.</p>
            ...
            <div class="swiper-slide">
              <p class="video-title">{{__('Why you can trust crypto funds and traders on Ninance platform')}}.</p>
            ...
            <div class="swiper-slide">
              <p class="video-title">{{__('Watch how Ninance simplifies investments process in the crypto field')}}.</p>
            ...
            <div class="swiper-slide">
              <p class="video-title">{{__('How blockchain technology works for investors & traders on Ninance platform')}}.</p>
