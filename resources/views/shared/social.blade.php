<div class="social">
    ...
    <a href="http://Ninance.slack.com" class="link slack" target="_blank"><i class="fa fa-slack"></i></a>
    <a href="mailto:support@Ninance.io" class="link email" title="Email"><i class="fa fa-envelope-o"></i></a>
